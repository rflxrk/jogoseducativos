...
describe Admin::GamesController do
  ...
  it_should_behave_like 'create action', valid: :game_attrs, invalid: :invalid_game_attrs, model: Game
  it_should_behave_like 'edit action', valid: :game
  it_should_behave_like 'update action', valid: :game_attrs, invalid: :invalid_game_attrs, model: Game
